...
func TestGetAQIStatus(t *testing.T) {
	testCases := []struct {
		...
		{"pm25 less equal 200", 199, StatusDetail{"#c20000", "ไม่ดีต่อสุขภาพ", "ใส่หน้ากากและเปิดเครื่องฟอกอากาศ"}},
		{"pm25 less equal 300", 299, StatusDetail{"#910ac2", "อันตรายต่อสุขภาพ", "งดออกนอกอาคารและเปิดเครื่องฟอกอากาศ"}},
		{"pm25 over 300", 350, StatusDetail{"#52291f", "อันตรายรุนแรง", "งดออกนอกอาคารและเปิดเครื่องฟอกอากาศ"}},
	}
